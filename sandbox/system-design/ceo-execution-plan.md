...
Start with  because it exercises the modern stack: API, queue, cache, database, vector database, embedding pipeline, LLM gateway, observability, fallback, and cost controls.
