...
Dominant concepts: Replication, CRDT or OT, WebSockets, operation log, active-state cache

Primary deep-dive areas: Conflict resolution, presence, offline edits, operation compaction
...
Conflict resolution, presence, offline edits, operation compaction
...
Document summarization, AI writing assistant, semantic document retrieval
