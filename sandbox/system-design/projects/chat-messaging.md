...
Dominant concepts: WebSockets, message queues, replication, database selection, observability

Primary deep-dive areas: Ordering, delivery semantics, presence, offline sync, group chat scale
...
Ordering, delivery semantics, presence, offline sync, group chat scale
...
Missed-message summaries, AI-assisted replies, moderation pipeline
