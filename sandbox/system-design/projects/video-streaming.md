...
Dominant concepts: CDN caching, queues, metadata storage, regional load balancing, observability

Primary deep-dive areas: Upload pipeline, transcoding, adaptive bitrate, live versus on-demand delivery
...
Upload pipeline, transcoding, adaptive bitrate, live versus on-demand delivery
...
Recommendation summaries, semantic video search, automated tagging
